...
app.get("/api/health", (req,res)=>{
  res.status(200).json({success:true,service:"BOSS KEYZO",license_validation:true});
});
...
app.post("/api/license/validate",(req,res)=>{
  ...
  res.status(200).json({
    valid:true,status:"active",key:license.key,
    expires_at:license.expires_at||null,
    device_bound:Boolean(bound),app_version:appVersion||null,
